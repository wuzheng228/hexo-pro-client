...
import { getAISettings, saveAISettings, AISettings } from '@/utils/aiSettings'
              ...
              <div style={{ marginBottom: 16 }}>
                <div style={{ marginBottom: 16 }}>
                  ...
                  <Input
                    ...
                    onChange={(e) => handleAISettingChange('url', e.target.value)}
                ...
                <div style={{ marginBottom: 16 }}>
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 8 }}>
                    ...
                    <Switch
                      ...
                      onChange={(checked) => handleAISettingChange('enableThinking', checked)}
                      checkedChildren={t['settings.enabled']}
                      unCheckedChildren={t['settings.disabled']}
                    />
                  </div>
                ...
                <div style={{ marginBottom: 16 }}>
                  ...
                  <Input
                    ...
                    onChange={(e) => handleAISettingChange('maxTokens', parseInt(e.target.value) || 4000)}
                    style={{ width: '100%', marginTop: 8 }}
                  />
                </div>
                ...
                <div style={{ marginBottom: 16 }}>
                  ...
                  <Input
                    ...
                    onChange={(e) => handleAISettingChange('temperature', parseFloat(e.target.value) || 0.7)}
                    style={{ width: '100%', marginTop: 8 }}
                  />
                </div>
                ...
                <div style={{ marginBottom: 16 }}>
                  ...
                  <Input
                    ...
                    onChange={(e) => handleAISettingChange('topP', parseFloat(e.target.value) || 0.9)}
                    style={{ width: '100%', marginTop: 8 }}
                  />
                </div>
              </div>
